# Voice card v1.6 classic (2026-09-18) — 16-bit multiply overflows fixed

**This is the classic build: the 16 wavetables and WAVEQUENCE are kept.**
Built with `--variant classic`. Everything below applies to both builds.
...
Flash 30,314 / 32,256. Static SRAM 1,073 / 1,920.
